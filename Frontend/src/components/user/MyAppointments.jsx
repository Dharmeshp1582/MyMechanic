...
//     if (status === "received")
//       return <span className="vehicle-status in-garage">In Garage</span>;
//     if (status === "returned")
//       return <span className="vehicle-status returned">Returned</span>;
//     return <span className="vehicle-status unknown">-</span>;
//   };
...
//                   <tr key={appt._id}>
//                     <td>
//                       {appt.serviceId.map((service) => service.name).join(", ") || "N/A"}
//                     </td>
...
//                       {appt.isPaid && (
//                         <button
//                           className="my-appoint-invoice-btn"
//                           onClick={() =>
//                             navigate(`paymentdetail/${appt._id}`)
//                           }
//                         >
//                           View Invoice
//                         </button>
