...
//   const invoiceRef = useRef(); // ✅ Ref for the invoice div
...
//         return axios.get(`/payment/getPaymentByAppointment/${id}`);
//       })
...
//           <p><strong>Name:</strong> {garageownerId?.name}</p>
//           <p><strong>Owner:</strong> {garageownerId?.userId?.fullName}</p>
//         </div>
...
export const Invoice = () => {
    ...
    return (
        <div className="invoice-container">
            ...
            <div className="invoice-box" ref={invoiceRef}>
                <h1 className="invoice-header">My Mechanic Invoice</h1>
                ...
                {payment?.userId && (
                    <div className="invoice-section">
                        <h2>User Details</h2>
                        <p><strong>Name:</strong> {payment.userId.fullName}</p>
                        <p><strong>Email:</strong> {payment.userId.email}</p>
                        <p><strong>Contact:</strong> {payment.userId.contact}</p>
                    </div>
                )}
                ...
                <div className="invoice-section">
                    ...
                    <p><strong>Garage Owner:</strong> {garageownerId?.userId?.fullName}</p>
                </div>
                ...
                <div className="invoice-footer">
                    <p>Thank you for choosing <strong>My Mechanic</strong> 🚗🔧</p>
                    <p className="invoice-note">
                        This invoice is generated digitally and does not require a signature. 
                        For questions, contact our support. <br />
                        © {new Date().getFullYear()} My Mechanic. All rights reserved. | Privacy Policy & Terms Apply.
                    </p>
                </div>
            </div>
        </div>
